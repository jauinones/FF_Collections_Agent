                ...
                try {
                    ...
                    if (!replyText) {
                        ...
                        const response = await axios.post("https://api.openai.com/v1/chat/completions", {
                            model: "gpt-3.5-turbo",
                            messages: [
                                { role: "system", content: `Provide a clear, concise, and informative response within 150 tokens and ensure the response ends at a complete sentence and use ${allFaqContext} as context, knowledge base when reply but don't respond if the incoming message is only emoji.` },
